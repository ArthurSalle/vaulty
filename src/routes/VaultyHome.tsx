...
export const VaultyHome = () => {
  return (
    <div className='w-full max-h-[calc(100dvh-53px)] md:max-h-[100dvh] overflow-y-auto pt-5 pb-2 px-4 flex flex-col justify-between gap-12 lg:gap-0'>
      <div>
        <motion.div
          animate={{ y: [-100, 0] }}
          transition={{
        ...
        >
          <h2 className='mt-12 text-3xl md:text-[2.8rem] tracking-wide leading-tight font-bold text-center [text-wrap:balance] px-4'>
            Store all your&nbsp;
          ...
          <div className='px-4 hidden lg:grid grid-cols-1 lg:grid-cols-3 gap-4 lg:max-w-5xl mx-auto w-full z-10 relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 sm:max-w-lg md:max-w-2xl lg:max-w-5xl w-full sm:px-4 mx-auto mt-12 lg:-mt-4'>
              ...
              <Card className='w-full h-full flex flex-col justify-between'>
                <div>
                  ...
                  <CardContent className='text-muted-foreground pr-12'>
                    ...
                    here, you can also set a default card for payment forms.
                  </CardContent>
                </div>
      ...
      >
        <span className='text-muted-foreground text-[12px] block'>
          This is a fictitious site created for training purposes only. Do not
          enter real information. Thank you.
        </span>
      </motion.div>
    </div>
  )
